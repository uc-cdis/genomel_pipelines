...
requirements:
  ...
  - class: DockerRequirement
    dockerPull: registry.gitlab.com/uc-cdis/genomel-primary-analysis:0.2c

inputs:
  - id: java_opts
    type: string
    default: "-Xmx4g"
    doc: JVM arguments should be a quoted, space separated list (e.g. -Xms128m or -Xmx512m)
    inputBinding:
      position: 1
      shellQuote: false
  ...
  - id: end_mode
    type: string
    doc: SE or PE. Single End (SE) or Paired End (PE) mode
    inputBinding:
      position: 3
  ...
  - id: phred
    type: string
    doc: 33 or 64. -phred33 ("33") or -phred64 ("64") specifies the base quality encoding.
    inputBinding:
      prefix: "-phred"
      separate: false
      position: 4
      ...
      glob: |
        ${
          if (inputs.end_mode == "PE")
            return inputs.input_read1_fastq_file.nameroot + '.unpaired.trimmed.fastq';
          return null;
        }
  ...
  - id: "#output_read2_trimmed_unpaired_file"
    ...
    outputBinding:
      glob: |
        ${
          if (inputs.end_mode == "PE" && inputs.input_read2_fastq_file)
            return inputs.input_read2_fastq_file.nameroot + '.unpaired.trimmed.fastq';
          return null;
        }
  - id: "#output_log_file"
    type: ['null', File]
...
baseCommand: java
arguments:
  - valueFrom: "/home/ubuntu/tools/Trimmomatic-0.36/trimmomatic-0.36.jar"
    position: 2
    prefix: "-jar"

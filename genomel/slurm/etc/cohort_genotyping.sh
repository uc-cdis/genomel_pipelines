...
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --workdir="/mnt/glusterfs/cromwell_workdir"

basedir="/mnt/glusterfs/cromwell_workdir"
project="{PROJECT}"
batch_id="{BATCH}"
job_uuid="{JOB_UUID}"
input_table="{INPUT_TABLE}"
psql_conf="/mnt/SCRATCH/reference/postgres_config"
gvcf_files_manifest="/mnt/glusterfs/cromwell_workdir/gvcf_local_path.list"
gatk4_genotyping_thread_count="20"
number_of_chunks_for_gatk="50"
bam_files_manifest="/mnt/glusterfs/cromwell_workdir/bam_local_path.list"
freebayes_thread_count="1"
number_of_chunks_for_freebayes="50"
upload_s3_bucket="s3://genomel/cohort_genotyping_output/"
cromwell_jar_path="/mnt/glusterfs/cromwell_workdir/cromwell-36.jar"
repository="git@github.com:uc-cdis/genomel_pipelines.git"

cd $basedir

sudo git clone -b feat/cohort_prod $repository genomel_pipelines

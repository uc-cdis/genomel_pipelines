...
if __name__ == "__main__":
    ...
    required.add_argument("--bam_s3dir", help="S3 for uploading BAM output files", required=True)
    required.add_argument("--fastq_s3dir", help="S3 for uploading FASTQ output files", required=True)
    ...
    for case in cases:
        ...
        for line in temp:
            ...
            if "XX_BAM_S3DIR_XX" in line:
                line = line.replace("XX_BAM_S3DIR_XX", args.bam_s3dir)
            if "XX_FASTQ_S3DIR_XX" in line:
                line = line.replace("XX_FASTQ_S3DIR_XX", args.fastq_s3dir)                

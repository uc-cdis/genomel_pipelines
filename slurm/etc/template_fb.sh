...
basedir=`sudo mktemp -d genomel.fb.XXXXXXXXXX -p /mnt/SCRATCH/`
refdir="XX_REFDIR_XX"
s3dir="XX_S3DIR_XX"
...
/home/ubuntu/.virtualenvs/p2/bin/python genomel_cwl/slurm/genomel_fb_pipeline.py \
...
--basedir $basedir \
--refdir $refdir \
--cwl $basedir/genomel_cwl/tools/variant_detection/freebayes/freebayes.cwl.cwl.yaml \
--s3dir $s3dir \

...
basedir=`sudo mktemp -d genomel.ug.XXXXXXXXXX -p /mnt/SCRATCH/`
refdir="XX_REFDIR_XX"
s3dir="XX_S3DIR_XX"
...
/home/ubuntu/.virtualenvs/p2/bin/python genomel_cwl/slurm/genomel_ug_pipeline.py \
...
--basedir $basedir \
--refdir $refdir \
--cwl $basedir/genomel_cwl/tools/variant_detection/UnifiedGenotyper.cwl.yaml \
--s3dir $s3dir \
